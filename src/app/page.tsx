...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <div className="header-gradient bg-gradient-to-r from-blue-300 to-purple-300 p-3 sm:p-5 rounded mb-6 sm:mb-8 mx-4 sm:mx-6 md:mx-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">4CFC</h1>
      </div>
      
      <div className="relative z-10 container mx-auto px-4 md:px-8 py-12 pb-32 md:py-16 md:pb-40 bg-amber-50">
        {/* Hero Section with enhanced typography */}
        <div className="max-w-5xl mx-auto text-center mb-20">
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold mb-6 text-gray-800 leading-tight tracking-tight">
          ...
          <p className="text-xl md:text-2xl text-gray-700 leading-relaxed mb-10 max-w-3xl mx-auto font-light">
        ...
        <p className="text-lg mb-10 text-center text-gray-700">
          For College Students, From College Students (4CFC) is your journey to higher education and beyond. We offer various systems of support so that you can unlock the door to a future that you can shape:
        </p>
        {/* Feature Cards Section with enhanced styling */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10 mb-16 sm:mb-24 md:mb-32">
          {cards.map((card, idx) => (
            <Link
              key={card.href}
              href={card.href}
            ...
            >
              <div className={`light-feature-card group p-4 sm:p-6 ${hovered === idx ? 'ring-2 ring-blue-400' : ''}`}>
                ...
                <p className="text-gray-700 mb-6 sm:mb-8 relative z-10">
                  {card.blurb}
                </p>
